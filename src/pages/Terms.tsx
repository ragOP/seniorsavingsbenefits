...
const Terms = () => {
  return (
    ...
    <p className="title">Terms and Conditions for seniorsavingsbenefits.com</p>
    </div>
    </div>
    ...
    <li>
    <p><strong>Website</strong> refers to seniorsavingsbenefits.com., accessible from <a href="www.seniorsavingsbenefits.com" rel="external nofollow noopener" target="_blank">https://www.seniorsavingsbenefits.com</a></p>
    </li>
    <li>
